...
static const Layout layouts[] = {
	...
	{ "TTT",	bstack },		/* New Default: Master on top, slaves on bottom */
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		    XK_e,		    spawn,		    SHCMD("/home/doom/zzz/softwares/eclipse/eclipse") },
	{ MODKEY,			        XK_r,		    spawn,		    SHCMD(TERMINAL " -e lf") },
	{ MODKEY|ShiftMask,		    XK_r,		    spawn,		    SHCMD(TERMINAL " -e htop") },
	{ MODKEY|ShiftMask,		    XK_t,		    setlayout,	    {.v = &layouts[0]} }, /* bstack */
	...
	{ MODKEY|ShiftMask,	        XK_p,			spawn,		    SHCMD("mpc shuffle") },
	...
	/* { MODKEY|ShiftMas        k,		XK_backslash,		    spawn,		SHCMD("") }, */

	{ MODKEY,			        XK_a,		    togglegaps,	    {0} },
	{ MODKEY|ShiftMask,	        XK_a,		    defaultgaps,	{0} },
	{ MODKEY,			        XK_s,		    togglesticky,	{0} },
	/* { MODKEY|ShiftMas        k,		XK_s,	spawn,		    SHCMD("") }, */
	...
	{ MODKEY,			        XK_F1,		    spawn,		    SHCMD("remaps") },
	{ MODKEY,			        XK_F2,		    spawn,		    SHCMD("tutorialvids") },
	{ MODKEY,			        XK_F3,		    spawn,		    SHCMD("displayselect") },
	{ MODKEY,			        XK_F4,		    spawn,		    SHCMD(TERMINAL " -e pulsemixer; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			        XK_F5,		    spawn,		    SHCMD("set dpms force off") },
	...
	{ 0,				        XK_Print,	    spawn,		    SHCMD("maim .local/share/screenshots/sc-full-$(date '+%y%m%d-%H%M-%S').png") },
